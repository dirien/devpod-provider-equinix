...
var checksumMap = map[string]string{
	"./release/devpod-provider-equinix-linux-amd64":       "##CHECKSUM_LINUX_AMD64##",
	"./release/devpod-provider-equinix-linux-arm64":       "##CHECKSUM_LINUX_ARM64##",
	"./release/devpod-provider-equinix-darwin-amd64":      "##CHECKSUM_DARWIN_AMD64##",
	"./release/devpod-provider-equinix-darwin-arm64":      "##CHECKSUM_DARWIN_ARM64##",
	"./release/devpod-provider-equinix-windows-amd64.exe": "##CHECKSUM_WINDOWS_AMD64##",
}
